...
- DonnÈes Taiwanaises peu fiable due aux changement d'especes visees rÈgulierement
...
* Projet : 
- Faire la revue + voir apres mercredi 25 pour la rÈunion concernant CPUE DCP
...
* Observations des donnees biologiques
...
* David, questionnement general.
* Francis, episode Natosquilla.

#### What did you achieve?

* Pas de cohorte flagrante decouverte "importante".
* Golden years serait en grande partie due au poid des calees qui augmentent.
* A priori les grosses calees sont etalees sur l'annee.
* Pas de pic de l'IOD sur cette periode (Indian Ocean Dipole)
...
* Recher indice El NiÒo-Southern Oscillation (ENSO).
...
#### Where do you need help from Daniel, LoreleÔ or others?
...
* Aper√ßu des disparites ou non des captures par trimestre mois sur quadrillage de 1 et 5 degre  

#### What did you struggle with?

* Choix de tonnage minimum pour resteindre l'analyse des zones √† de grandes captures
...
#### Where do you need help from Daniel, Lorele√Ø or others?
...
* Gwenaelle, Alex (petit tho, ? revoir)
  * LG: Est-ce que tu peux d√©tailler pour chaque personne l'objet et le temps que √ßa t'a demand√© peut-√™tre, ou toute autre info que tu penseras utile? :smirk:
...
* Visite m√©dicale et sociale
* Premiere approche g√©ographique des donnees

  * LG: :clap: :clap: N'h√©site pas √† nous montrer tes trouvailles!
